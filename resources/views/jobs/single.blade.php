            ...
            <div class="row mb-5">
              <div class="col-6">
                <form action="{{ route('save.job') }}" method="POST">
                    ...
                    @if($savedJob > 0)
            <button class="btn btn-block btn-light btn-md bg-warning color-green" disabled>You have saved this job!!!</button>
                    @else
          ...
          <div class="col-lg-4">
            <div class="bg-light p-3 border rounded mb-4">
              ...
              <ul class="list-unstyled pl-3 mb-0">
                ...
                <li class="mb-2"><strong class="text-black">Experience:</strong> {{$job->experience}}(s)</li>
